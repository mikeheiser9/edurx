      ...
      <Field
        ...
        component={({
          ...
          <p className="text-eduBlack font-body text-center text-[14px]">
            We sent an email to{" "}
            <span className="text-eduLightBlue font-body text-center text-[14px]">{field.value}</span>. Please enter
...
const RegistrationConfirmationMessage = (): React.JSX.Element => {
  return (
    <React.Fragment>
      <p className="text-[14px] text-center text-eduBlack/60 font-body">
