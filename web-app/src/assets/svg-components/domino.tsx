...
const Domino: React.FC<DominoProps> = ({ viewBoxDimensions, forwardedRefs, translate }) => {

  return (
    <>
        <svg 
            xmlns="http://www.w3.org/2000/svg" 
            className='w-screen h-[650px] fixed top-0 left-0'
        ...
        >
            ...
            <g id="Layer_1" data-name="Layer 1"  transform={`translate(${translate.x}, ${translate.y})`}>
                <g>
            ...
            <g id="Layer_3" data-name="Layer 3" ref={forwardedRefs.circleOne} transform={`translate(${translate.x}, ${translate.y})`}>
                <circle cx="48.52" cy="27" r="13.33" fill="url(#linear-gradient-5)"/>
            </g>
            <g id="Layer_2" data-name="Layer 2" ref={forwardedRefs.circleTwo} transform={`translate(${translate.x}, ${translate.y})`}>
                <circle cx="48.52" cy="145.67" r="13.33" fill="url(#linear-gradient-6)"/>
            </g>
            <g id="Layer_4" data-name="Layer 4" ref={forwardedRefs.circleThree} transform={`translate(${translate.x}, ${translate.y})`}>
                <circle cx="82.29" cy="179.45" r="13.33" fill="url(#linear-gradient-7)"/>
            </g>
            <g id="Layer_5" data-name="Layer 5" ref={forwardedRefs.circleFour} transform={`translate(${translate.x}, ${translate.y})`}>
                <circle cx="116.08" cy="217.22" r="13.33" fill="url(#linear-gradient-8)"/>
            </g>
            <g id="Layer_6" data-name="Layer 6" ref={forwardedRefs.circleFive}>
                <circle cx="48.52" cy="217.22" r="13.33" fill="url(#linear-gradient-9)" transform={`translate(${translate.x}, ${translate.y})`} />
            </g>
            <g id="Layer_7" data-name="Layer 7" ref={forwardedRefs.rxOne} transform={`translate(${translate.x}, ${translate.y})`}>
            ...
            <g id="Layer_8" data-name="Layer 8" ref={forwardedRefs.rxTwo} transform={`translate(${translate.x}, ${translate.y})`}>
