  ...
  return (
    <>
        ...
        >
            ...
            <g id="Layer_3" data-name="Layer 3" ref={forwardedRefs.circleOne}>
                <circle cx="48.52" cy="27" r="13.33" fill="url(#linear-gradient-5)"/>
            </g>
            <g id="Layer_2" data-name="Layer 2" ref={forwardedRefs.circleTwo}>
                <circle cx="48.52" cy="145.67" r="13.33" fill="url(#linear-gradient-6)"/>
            </g>
            <g id="Layer_4" data-name="Layer 4" ref={forwardedRefs.circleThree}>
                <circle cx="82.29" cy="179.45" r="13.33" fill="url(#linear-gradient-7)"/>
            </g>
            <g id="Layer_5" data-name="Layer 5" ref={forwardedRefs.circleFour}>
            ...
            <g id="Layer_7" data-name="Layer 7" ref={forwardedRefs.rxOne}>
            ...
            <g id="Layer_8" data-name="Layer 8" ref={forwardedRefs.rxTwo}>
